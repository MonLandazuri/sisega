          ...
          <form method="POST" action="{{ route('guardar.nuevopartida')}}" class="wizard-content mt-2">
            ...
            <div class="wizard-pane">
              ...
              <div class="form-group row align-items-center">
                ...
                <div class="col-lg-4 col-md-6">
                  <input list="unidades_sugeridas" name="unidad_partida" id="unidad_partida" class="form-control" required>
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-4 col-md-6 text-right">
                  ...
                  <!--<input type="submit" class="btn btn-icon icon-right btn-danger" value="Guardar">-->
                </div>
              </div>
            </div>
          </form>
