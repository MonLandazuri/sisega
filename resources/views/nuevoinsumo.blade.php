...
<section class="section">
          <div class="section-header">
            <h1>Nuevo Elemento Insumo</h1>
          </div>
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4>Agregar Nueva Insumo</h4>
        </div>
        <div class="card-body">
          <div class="row mt-4">
          ...
          @endif
          <form method="POST" action="{{ route('guardar.nuevoinsumo')}}" class="wizard-content mt-2">
                @csrf
            <div class="wizard-pane">
              <div class="form-group row align-items-center">
                <label class="col-md-4 text-md-right text-left">NO</label>
                <div class="col-lg-4 col-md-6">
                  <input type="text" name="no_insumo" class="form-control">
                </div>
              </div>
              <div class="form-group row align-items-center">
                <label class="col-md-4 text-md-right text-left">CONCEPTO</label>
                <div class="col-lg-4 col-md-6">
                  <textarea class="form-control" name="concepto_insumo"></textarea>
                </div>
              </div>
              <div class="form-group row align-items-center">
              ...
              <div class="form-group row align-items-center">
                ...
                <div class="col-lg-4 col-md-6">
                  <input type="text" name="zonadeuso_insumo" class="form-control">
                </div>
              </div>
